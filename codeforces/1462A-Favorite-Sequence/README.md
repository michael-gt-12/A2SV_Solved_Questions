...
**Problem:** [1462A-Favorite-Sequence](https://codeforces.com/contest/1462/problem/A)
...
-  Polycarp continued to act as well, until he wrote out the entire sequence on the whiteboard. 
 ![image](https://espresso.codeforces.com/09d364313ed093967e3ce6d2ebeda9cf8aa87d19.png)   The beginning of the result looks like this (of course, if n ≥ 4). For example, if n=7 and a=[3, 1, 4, 1, 5, 9, 2], then Polycarp will write a sequence on the whiteboard [3, 4, 5, 2, 9, 1, 1].
...
The next line contains n integers b_1, b_2,…, b_n (1 ≤ b_i ≤ 10⁹) — the sequence written on the whiteboard.
